...
function updateMaxWidth(){
  let elems = document.querySelectorAll('#wrap :not(br):not(style):not(#toggleSidebar):not(#mobileHeader):not(#mobileHeader *):not(#sidebar)');
